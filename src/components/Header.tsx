    ...
    return (
        ...
        >
            <div className="inner flex flex-col">
                <div className={`flex items-center justify-between h-20 flex-shrink-0 transition-all duration-500 ${isMenuOpen ? 'mb-4' : 'mb-0'}`}>
                    <Link href="/">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            onClick={toggleMenu}
                        >
                            {isMenuOpen ? <X className="text-rose-400"/> : <Menu />}
                        </button>
                    </div>
                </div>
                <nav className={`flex items-center justify-center gap-10 transition-all duration-500 overflow-hidden ${isMenuOpen ? "h-fit opacity-100 pb-4" : "h-0 opacity-0"}`}>
                    <Link href="/" className="font-ns-bold hover:text-primary transition-colors">
                        <span>거래 내역</span>
                    </Link>
                    <Link href="/" className="font-ns-bold hover:text-primary transition-colors">
                        <span>가맹점 목록</span>
